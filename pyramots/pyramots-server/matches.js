...
module.exports = function(app) {
    ...
    app.get('/test', function(request, response) {
        console.log('yes');
        response.json({'success': false, 'error': {message:'oupsi'}});
    })
    
    app.post('/get-game', function(request, response) {
        var contextId = request.body.number;
        response.json({'success': true, 'msg': DATA[contextId]});
    })
